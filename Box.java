 ...
 *     @return the minimum distance to that particle among all its replicates in 2D */
	...
	public static double minIn3(double a, double b, double c, double center) {
        ...
        /**moves a random particle in a random direction by a random distance generated by expo distribution
 *      @param lambda double, the parameter of the exponential distribution
 *      @param dummy int, a dummy integer distinguishing betweeen this method and the next
 *      @return Movement, what movement has occured. */
        public Movement move(double lambda, int dummy) {
		if (dummy != 1) {
			throw new IllegalArgumentException("dummy must be 1");
		}
                ...
                double dist = expoRandomNumber(lambda);
